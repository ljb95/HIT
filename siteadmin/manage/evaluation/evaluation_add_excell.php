...
<div id="contents">
    ...
    <div id="content">
        <h3 class="page_title"><?php echo get_string('add_sample2','local_lmsdata'); ?></h3>
        <div class="page_navbar"><a href="./category_list.php"><?php echo get_string('course_management', 'local_lmsdata'); ?></a> > <a href="evaluation_form.php"><?php echo get_string('evaluation_questionnaire', 'local_lmsdata'); ?></a> > <a href="evaluation_form.php"><?php echo get_string('eval_form','local_lmsdata'); ?></a> > <strong><?php echo get_string('add_sample2','local_lmsdata'); ?></strong></div>
        ...
        <form id="evaluation_add_form" action="evaluation_submit.php" onsubmit="return validateRequiredFields();" method="post" enctype="multipart/form-data"> 
            <div>
                <table cellpadding="0" cellspacing="0" class="detail">
                    ...
                    <input type="hidden" name="excell" value="1" />
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="field_title"><label for="form_content"><?php echo get_string('excellfile','local_lmsdata'); ?></label></td>
                            <td class="field_value">
                                <input type="file" name="excell_file" />
                                <br/>
                                ><?php echo get_string('sample_dec','local_lmsdata'); ?> <a href="<?php echo $CFG->wwwroot;?>/siteadmin/manage/evaluation/Samples.zip" style="color:red;" >[<?php echo get_string('download_sample','local_lmsdata'); ?>]</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
