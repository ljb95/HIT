...
class sendmessage_form extends moodleform {
    ...
    public static function editor_options($context, $historyid) {
        ...
        return array(
            ...
            'subdirs' => file_area_contains_subdirs($context, 'local_sendmessage', 'contents', $historyid)
        );
    }
    ...
    function definition() {
        ...
        $mform->addElement('editor', 'contents', get_string('matilcontents', 'local_sendmessage'), null, self::editor_options($context, (empty($content->id) ? null : $content->id)));
