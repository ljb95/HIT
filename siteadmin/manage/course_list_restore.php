...
$sql_from    = " FROM {course} mc
                 ...
                 JOIN (
                  SELECT DISTINCT standard_id FROM {lmsdata_class_drive_log} WHERE (type = 0 or type = 2) and restore_flag = 1
...
<div id="contents">
    ...
    <div id="content">
        <h3 class="page_title">분반되돌리기내역</h3>
        <div class="page_navbar"><a href="./category_list.php"><?php echo get_string('course_management', 'local_lmsdata'); ?></a> > <a href="./course_list.php"><?php echo get_string('opencourse', 'local_lmsdata'); ?></a> > 분반되돌리기내역</div>
        <div class="content_navigation">
            <a href="course_list.php"><p class="black_btn">강의리스트</p></a>
            <a href="course_list_merge.php"><p class="black_btn ">분반통합내역</p></a>
            <a href="course_list_restore.php"><p class="black_btn black_btn_selected">분반되돌리기내역</p></a>
        ...
        <table>
            ...
            <?php
                if($count_courses === 0) { ?>
                <tr>
                    <td colspan="8"><?php echo get_string('empty_course','local_lmsdata'); ?></td>
                </tr>
                <?php } else {
