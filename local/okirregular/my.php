...
$PAGE->set_url('/local/okirregular/my.php');
...
$row[] = new tabobject(2, "$CFG->wwwroot/local/okirregular/my.php", get_string('pluginname', 'local_okirregular'));
$rows[] = $row;
...
//tab
$row = $rows =  array();
$row[] = new tabobject('1', "$CFG->wwwroot/local/okirregular/my.php?type=1", get_string('ongoing', 'local_okirregular'));
$row[] = new tabobject('2', "$CFG->wwwroot/local/okirregular/my.php?type=2", get_string('standby', 'local_okirregular'));
$row[] = new tabobject('3', "$CFG->wwwroot/local/okirregular/my.php?type=3", get_string('finish', 'local_okirregular'));
$rows[] = $row;
