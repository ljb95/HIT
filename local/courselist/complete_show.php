...
$PAGE->set_url('/local/courselist/complete_show.php');
...
$strplural = get_string('course:completion', 'local_courselist');
...
<div class="user_info">
    <div class="option_grade"><p><?php echo get_string('complete:grade_sum', 'local_courselist').' : '.$total_grade; ?></p></div>
</div>
...
<table class="generaltable course_syllabus_table" cellpadding="0" cellspacing="0">
    <thead>
        <tr>
            ...
            <th class="th_certificate"><?php echo get_string('complete:certificate', 'local_courselist'); ?></th>
        </tr>
    </thead>
    <tbody>
        <?php
        ...
        ?>
            <tr>
                ...
                <td class="certificate">
                    ...
                    ?>
                        <input type="button" class="red-form" value="<?php echo get_string('issue', 'local_courselist'); ?>" onclick="javascript:location.href = '<?php echo $CFG->wwwroot."/local/courselist/certificate_pdf.php?id=".$complete->course;?>'"/>
                    <?php
                            } else {
                    ?>
                        <input type="button" class="red-form" value="<?php echo get_string('questionnaire', 'local_courselist'); ?>" onclick="javascript:location.href = '<?php echo $CFG->wwwroot."/course/view.php?id=".$complete->course;?>'"/>
                    <?php
                            }
                    ?>
                    <?php } ?>
        ...
        <?php
            ...
            ?>          
            <tr>
                <td class="empty" colspan="5"><?php echo get_string('complete:empty', 'local_courselist');?></td>
            </tr>
...
<div class="complete_type">
    ...
    <div class="complete_help"><?php echo get_string('employment', 'local_courselist');?></div>
</div>
...
<div class="table-footer-area">
    ...
    <!--<input type="button" class="red-form" value="<?php echo get_string('return', 'local_courselist'); ?>" onclick="javascript:location.href = '<?php echo $CFG->wwwroot;?>'"/>-->
</div>
<?php            
    echo $OUTPUT->footer();
?>
