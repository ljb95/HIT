...
<div id="contents">
    ...
    <div class="page_navbar"><a href="<?php echo $CFG->wwwroot . '/siteadmin/contents/index.php'; ?>"><?php echo get_string('lcms_management', 'local_lmsdata'); ?></a> > <a href="#"><?php echo get_string('contents_packageregistration', 'local_lmsdata'); ?></a></div>
