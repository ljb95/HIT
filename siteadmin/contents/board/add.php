...
<div id="contents">
    ...
    <div class="page_navbar"><a href="index.php"><?php echo get_string('board_management', 'local_lmsdata'); ?></a> > <a href="./notices.php">게시판 등록</a></div>
    ...
    <tbody>
        <tr>
            ...
            <td class="field_value">
                <input type="text" class="w_300" name ="name" value="<?php echo (!empty($temp->title))?$temp->title:""; ?>"/>
            </td>
        </tr>
        <tr>
            <td class="field_title"><?php echo get_string('siteadmin_boardnameen', 'local_lmsdata'); ?></td>
            <td class="field_value">
                <input type="text" class="w_300" name ="engname" value="<?php echo (!empty($temp->title))?$temp->title:""; ?>"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="field_value">
                ...
                <input type="number" name="newday" class="w_50" size="3" value="3" maxlength="3"> <?php echo get_string('contents_day', 'local_lmsdata'); ?>
            </td>
        </tr>
        <tr>
