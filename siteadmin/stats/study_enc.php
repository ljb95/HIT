...
<div id="contents">
    ...
    <div id="content">
        ...
        <div class="page_navbar"><a href="./category_list.php"><?php echo get_string('course_management', 'local_lmsdata'); ?></a> > <a href="./category_list.php"><?php echo get_string('course_management', 'local_lmsdata'); ?></a> > <?php echo get_string('board_list', 'local_lmsdata'); ?></div>
        ...
        <form name="" id="course_search" class="search_area" action="category_list.php" method="get">
            ...
            <select name="search" class="w_160">
                <option value="1" <?php echo ($search==1)? 'selected':'';?>>- <?php echo get_string('contents_all', 'local_lmsdata'); ?> -</option>
                <option value="2" <?php echo ($search==2)? 'selected':'';?>>학정번호</option>
                <option value="3" <?php echo ($search==3)? 'selected':'';?>>과정명</option>
            </select> 
            <input type="text" name="searchtext" value="<?php echo $searchtext; ?>" placeholder="검색어를 입력하세요."  class="search-text"/>
            <input type="submit" class="blue_btn" value="<?php echo get_string('stats_search', 'local_lmsdata'); ?>"/>          
        ...
        <table>
            <tr>
                ...
                <th width="10%">학정번호</th>
                <th width="20%"><?php echo get_string('stats_classification', 'local_lmsdata'); ?></th>
                <th>과정명</th>
            ...
            if($count_datas > 0){
                ...
                echo '<tr><td colspan="5">등록된 과정이 없습니다.</td></tr>';
            }
            ?>
            
        </table><!--Table End-->
        <div class="btn_area">
            <input type="button" value="과정등록" onclick="location.href = 'category_list_add.php'" class="blue_btn" style="float:right;"/>
        </div>  
