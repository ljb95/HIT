...
class local_courselist_block_course_overview_renderer extends block_course_overview_renderer {
...
//            }
            ...
            if (!empty($overviews[$course->id])) {
                ...
                $html .= ' <div class="activity_info1">
                               <div class="activity_overview">
                               ' . get_string('empty:courseoverview', 'local_courselist') . '
                               </div>
                            </div>';
            }
    ...
    protected function activity_display($cid, $overview) {
        $output = html_writer::start_tag('div', array('class' => 'activity_info1'));
