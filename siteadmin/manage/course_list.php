...
$sql_orderby = " ORDER BY lc.timestart DESC, lc.subject_id ASC, mc.fullname ASC, mc.timecreated DESC, mc.id DESC";
            ...
            <thead>
                <tr>
                    ...
                    <?php if ($coursetype == 0) { 
                        ...
                        echo '<th scope="row" width="5%">교수직종</th>';  
                    } ?>
            ...
            <?php if ($count_courses === 0) { ?>
                ...
                foreach ($courses as $course) {
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
//                           echo $course->firstname =="" ?$course->lastname : $course->firstname;
                            $teacherlist = "";
                            foreach ($teachers as $teacher) {
                                $teacherlist .= $teacher->firstname.', ';
                            }
                            echo substr($teacherlist , 0, -2);
                            ?>
                        </td>
