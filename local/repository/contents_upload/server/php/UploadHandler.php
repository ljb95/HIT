...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
		...
		global $sess_id,$file_type;

        $this->options = array(
            'script_url' => $this->get_full_url().'/index.php',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/'.$sess_id.'/',
            'upload_url' => $this->get_full_url().'/files/'.$sess_id.'/',
            'user_dirs' => false,
            'mkdir_mode' => 0777,
            'param_name' => 'files',
            ...
            //'accept_file_types' => '/.(zip|hwp|doc|docx|ppt|pptx|xls|xlsx|pdf|mp4|wmv|mp3|html)$/i',
            'accept_file_types' => '/.*$/i',
