        ...
        ?>                     
            <div class="popup" id="popup_<?php echo $popup->id; ?>" style="width:<?php echo $popup->popupwidth; ?>px; height:<?php echo $popup->popupheight; ?>px; left:<?php echo $popup->popupx; ?>px; top:<?php echo $popup->popupy; ?>px;">
                <div class="main_popup_header">
                    <h2 class="popup_title"><?php echo $popup->title; ?><a href="#" onclick="<?php echo 'closepopup(\'popup_' . $popup->id . '\')' ?>" class="right"><img src="<?php echo $CFG->wwwroot; ?>/siteadmin/img/close_icon_popup.png" width="12px" height="12px" alt="Close" title="Close"></a></h2>
                </div>
                    ...
                    <div style="margin-top:5px;" class="p-footer">
                        <form class="popup_btn_area">
                            ...
                            if ($popup->cookieday > 0) {
                                echo '<input type="checkbox" name="confirmed" title="confirmed" id="confirmed" onclick="closeWin(\'popup_' . $popup->id . '\', \'no\', \'' . $popup->cookieday . '\')">' . get_string("closepopupdays", "local_popup", $popup->cookieday);
                            }
                            ?>
                        </form>
                    </div>  
