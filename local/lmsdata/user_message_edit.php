...
$type = optional_param('type', "message", PARAM_TEXT);

$url = new moodle_url('/local/lmsdata/user_message_edit.php');
$url->param('id', $id);
...
/// Set all the processor options as well
    ...
    redirect("$CFG->wwwroot/local/lmsdata/user_message_edit.php?id=$user->id");
}
