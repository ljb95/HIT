...
if (isguestuser()) {
    $SESSION->wantsurl = (string)new moodle_url('/siteadmin/stats/contact_stats_day_week.php');
...
<div id="contents">
    ...
    <div id="content">
        ...
        <div class="page_navbar"><a href="./contact_stats_day_week.php"><?php echo get_string('stats_management', 'local_lmsdata'); ?></a> > <?php echo get_string('stats_loginstats', 'local_lmsdata'); ?></div>
        ...
        <?php
            $url = $CFG->wwwroot.'/siteadmin/stats/contact_stats_day_week.php?'; 
