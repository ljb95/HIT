...
<form id="course_searchform" method="post" onsubmit="return false;">
    ...
    <input type="submit" id="course_searchbtn" class="blue_btn" value="<?php echo get_string('search','local_lmsdata'); ?>"/>          
</form>
<table>
    <col width="10%">
    <col width="50%">
    ...
    foreach ($courses as $course) {
        ...
        <tr>
            ...
            <td><input type="button" class="blue_btn" value="<?php echo get_string('select','local_lmsdata'); ?>" onclick="course_selete(<?php echo $course->id; ?>, '<?php echo $course->fullname; ?>')"></td>
        </tr>
    <?php } if($cnt == 1){ ?>
        <tr>
