...
<div id="contents">
    ...
    <div id="content">
        <h3 class="page_title"><?php echo get_string('add_category','local_lmsdata'); ?></h3>
        <div class="page_navbar"><a href="./category_list.php"><?php echo get_string('course_management', 'local_lmsdata'); ?></a> > <a href="evaluation_form.php"><?php echo get_string('evalandsur','local_lmsdata'); ?></a> > <a href="evaluation_form.php"><?php echo get_string('eval_form','local_lmsdata'); ?></a> > <a href="evaluation_categories.php?formid=<?php echo $formid; ?>"><?php echo get_string('prev_sample','local_lmsdata'); ?></a> > <strong><?php echo get_string('add_category','local_lmsdata'); ?></strong></div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="field_value">
                                <input type="text" id="form_name" name="name" value="<?php echo $max; ?>. " placeholder="<?php echo get_string('category_name','local_lmsdata'); ?>" size="80" maxlength="30" required />
                            </td>
                        </tr>
                        <tr>
                            <td class="field_title"><label for="form_sortorder"><?php echo get_string('order','local_lmsdata'); ?></label></td>
                            <td class="field_value">
                                <input type="text" name="sortorder" id="form_sortorder" value="<?php echo $max; ?>" placeholder="ex) 1" size="2" />
                                <?php
                                echo rtrim($used, ',');
                                ?>
                            </td>
